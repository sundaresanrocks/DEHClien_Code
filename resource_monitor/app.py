...
app = Flask(__name__)
# os.environ.get('', '')
app.config['non_uid_container_ids'] = []
app.config['read_uid_from'] = "label" # or rrm
app.config['LOGLEVEL'] = os.environ.get('LOGLEVEL', 'INFO')
...
app.config['docker_host'] = os.environ.get('docker_host', 'https://192.168.0.65:2375/')#"https://10.0.10.132:2375/"
# app.config['docker_hostname'] = "10.0.10.132"
app.config['tls_cert_path'] = os.environ.get('tls_cert_path', '/app/DEHClientEnabler/resource_monitor')
app.config['deh_client_port'] = os.environ.get('deh_client_port', '5555')
...
app.config['auto_register_bse'] = os.environ.get('auto_register_bse', "False")
...
# BSE PROD instance
app.config['DEH_BSE_Host'] = os.environ.get('DEH_BSE_Host', 'https://bse.h2020-demeter-cloud.eu')
app.config['DEH_BSE_Proxy_URL'] = os.environ.get('DEH_BSE_Proxy_URL', 'https://bse.h2020-demeter-cloud.eu:443')
...
app.config['mongo_host'] = os.environ.get('MONGODB_HOST', "localhost")
app.config['mongo_port'] = os.environ.get('MONGO_DB_PORT', 27017)
...
# app.config['DEH_ACCOUNT_MAIL'] = os.environ.get('DEH_ACCOUNT_MAIL', 'antonio.caruso@eng.it')
# app.config['DEH_ACCOUNT_PASS'] = os.environ.get('DEH_ACCOUNT_PASS', 'blabla01')
